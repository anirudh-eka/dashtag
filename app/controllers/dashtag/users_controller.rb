...
module Dashtag
  class UsersController < ApplicationController
    ...
    def create
      ...
      if @user.save
        log_in @user
        flash[:success] = "Great, you're registered! Now it's time to setup your Dashtag page. Below are the settings you can edit. If you ever want to change the settings just click on the gear icon in the top right!"
