...
describe InstagramVideoHelper do
  context 'with video' do
    ...
    describe 'instagram_embed_video' do
      subject { helper.instagram_embed_video post_with_video }
  ...
  context 'with no video' do
    ...
    describe 'instagram_embed_twitter' do
      subject { helper.instagram_embed_video post_without_video }
